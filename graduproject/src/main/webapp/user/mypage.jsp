...
<body>
	<div class="w3-content w3-container w3-margin-top">
		<div class="w3-container w3-card-4">
			...
			<div>
				<form id="myForm" action="../user/update_mypage.do" method="post">
					<p>
						<label>ID</label> 
					...
					<p>
						<label>Name</label> 
						<input class="w3-input" id="named" name="named" type="text" value="${ user.named }" required>
					</p>
					<p>
					<!-- 
						<label>Birthday</label> 
						<input class="w3-input" id="birthday" name="birthday" type="text" value="${ user.birthday }" required>
						 -->
						<label>Birthday</label> 
						<input oninput="maxLengthCheck(this)" type="number" maxlength="6" max="999999"
							 class="w3-input" id="birthday" name="birthday" value="${ user.birthday }" required>
					</p>
					<p>
						<label>Email</label> 
						<input class="w3-input" type="text" id="email" name="email" readonly value="${ user.email }" required> 
					</p>
					<p class="w3-center">
				...
				<br />
				<form id="pwForm" action="../user/update_pw.do" method="post">	
				...
				<br />
				<form id="wdForm" action="../user/withdrawal.do" method="post">
